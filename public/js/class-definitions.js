...
function favoritePlanet(currentPlanet){
	...
	let randomPlanet = planets[random];
...
SolarSystem.prototype.addPlanet = function(){
	return this.planets.push(planets);
};

SolarSystem.prototype.removePlanet = function(){
	return this.planets.shift(planets);
};
/* Step 33
 *
 ...
 *
 */
var openAClosedBox = new Box('foods', false).openBox();
var closeAnOpenBox = new Box('foods', true).openBox();
 ...
 *
 */
var farTooTallAStory = new House(5).isATallStory(5);
var shortStory = new House(2).isATallStory(8);
...
var cookieMonsterBlocked = new Cookie('chocolate').swipedByCookieMonster();
